...
// ------------------------------------------
// UPDATED FORM VALIDATION (animalType removed)
// ------------------------------------------
export const validateAnimalForm = (formData) => {
    const errors = {};
    ...
    // Removed animalType validation because model predicts species
    // const animalTypeError = validateRequired(formData.animalType, 'Animal type');
    // if (animalTypeError) errors.animalType = animalTypeError;
    ...
    // NEW OPTIONAL CHECK (if needed):
    // species comes from AI prediction, so no validation required
